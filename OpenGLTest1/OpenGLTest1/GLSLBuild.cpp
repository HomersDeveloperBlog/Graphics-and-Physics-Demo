...
OpenGLShaderSource::OpenGLShaderSource(
    const OpenGLShaderFile & i_oShaderFile)
		: m_glnShaderType(ConvertInternalShaderEnumToOGL(
			i_oShaderFile.m_eShaderTypeInternal)),
		m_strShaderSource(ReadFileIntoBuffer(
			i_oShaderFile.m_strShaderFileName))
{
	//m_glnShaderType = ConvertInternalShaderEnumToOGL(
	//	i_oShaderFile.m_eShaderTypeInternal);
	//m_strShaderSource = ReadFileIntoBuffer(
